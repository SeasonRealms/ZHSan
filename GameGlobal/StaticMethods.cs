...
namespace GameGlobal
{
    ...
    {
        // B0：原依賴 MersenneTwister 套件（Randoms.Create 的 dSFMT 發生器），改以 System.Random 等價替代：
        // Next/NextDouble API 相同，同為非確定隨機序列，語義上無差異。
        public static Random RandomDigit = new Random();
