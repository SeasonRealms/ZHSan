...
/// <summary>
/// Mac Catalyst 入口：宿主為引擎 Season.Platforms.MacCatalyst.MacCatalystApp（UIKit + Metal），
/// 接線方式對照 Linux 的 Linux.cs（net10.0 TFM）。
/// </summary>
public class Program
{
    static void Main(string[] args)
    {
        // 注入 Mac Catalyst 平台實現（參考引擎 DeviceServices 的做法），
        ...
        try
        {
            ...
            // 该开关是一次性的：必须早于平台初始化（MacCatalystApp.Run → InitializeMetal），
            ...
            global::Season.Platforms.MacCatalyst.MacCatalystApp.Run(new Game1());
        }
